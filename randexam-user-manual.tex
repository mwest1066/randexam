...
\title{\texttt{randexam}: Randomized Exam Generation and Grading\\[1em] User Manual\\[1em] \Large Version 1.14.1}
\date{\vspace*{-2em}2016-09-29}
\maketitle
...
\item Run \texttt{./randexam proc-email}. This will ask for the NetID
  ...
  your NetID needs to be authorized by Technology Services. This only
  needs to be done once, as it will stay authorized. To do this, send
  email to the Technology Services Help Desk at
  \texttt{consult@illinois.edu} with the message ``I request IMAP
  access for my email.''

  After each email has been sent, a file is created in the feedback
