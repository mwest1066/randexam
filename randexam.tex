...
\title{Randomized Exam Generation and Grading\\[0.5em] Version 1.0.0}
\author{Matt West}
\date{}
\maketitle
...
\begin{align}
  ...
  P^{\rm max}_{\rm Q}(Q) &= \max_{\substack{V \in \{1,\ldots,N_{\rm V}\} \\ A \in \{1,\ldots,N_{\rm A}\}}}
  P(Q,V,A) \displaybreak[0] \\
